...
instance Applicative ExactlyOne where
  ...
  (<*>) ::
    ...
    -> ExactlyOne a
    -> ExactlyOne b
  (<*>) eoab eoa =  mapExactlyOne (runExactlyOne eoab) eoa
...
instance Applicative List where
  ...
  (<*>) ::
    ...
    -> List a
    -> List b
  (<*>) lab la = foldRight (\f b -> (map f la) ++ b) Nil lab
...
instance Applicative Optional where
  ...
  (<*>) ::
    ...
    -> Optional a
    -> Optional b
  (<*>) oab oa = bindOptional (\f' -> mapOptional f' oa) oab
...
lift3 ::
  ...
  -> k c
  -> k d
lift3 abcd fa fb fc = (pure abcd) <*> fa <*> fb <*> fc
...
lift4 ::
  ...
  -> k d
  -> k e
lift4 abcde fa fb fc fd = pure abcde <*> fa <*> fb <*> fc <*> fd
